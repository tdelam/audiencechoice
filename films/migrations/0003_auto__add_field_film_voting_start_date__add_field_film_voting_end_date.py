...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'films.film': {
            ...
            'voting_end_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'voting_start_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
