...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Film.description'
        db.delete_column(u'films_film', 'description')

        # Deleting field 'Film.description_html'
        db.delete_column(u'films_film', 'description_html')


    def backwards(self, orm):
        # Adding field 'Film.description'
        db.add_column(u'films_film', 'description',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'Film.description_html'
        db.add_column(u'films_film', 'description_html',
