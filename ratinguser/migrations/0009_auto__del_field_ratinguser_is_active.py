...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RatingUser.is_active'
        db.delete_column(u'ratinguser_ratinguser', 'is_active')


    def backwards(self, orm):
        # Adding field 'RatingUser.is_active'
        db.add_column(u'ratinguser_ratinguser', 'is_active',
